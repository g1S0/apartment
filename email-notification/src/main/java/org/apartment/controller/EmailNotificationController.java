...
import org.apartment.service.EmailNotificationService;
...
public class EmailNotificationController {
  ...
  public String triggerEmail(@RequestParam("email") String email) {
    emailNotificationService.sendRegistrationSuccessEmail(email);
